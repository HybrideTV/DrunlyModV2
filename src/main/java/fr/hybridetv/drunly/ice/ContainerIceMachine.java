...
public class ContainerIceMachine extends Container
{
	...
	public ContainerIceMachine(InventoryPlayer playerInventory, IInventory furnaceInventory) 
	{
		this.tileFurnace = furnaceInventory;
		this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
		this.addSlotToContainer(new SlotIceMachineFuel(furnaceInventory, 1, 56, 53));
		this.addSlotToContainer(new SlotIceMachineOutput(playerInventory.player, furnaceInventory, 2, 116, 35));
	...
	public ItemStack transferStackInSlot(EntityPlayer playerIn, int index) 
	{
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (!IceMachineRecipes.instance().getCookingResult(itemstack1).isEmpty())
                {
                ...
                else if (TileEntityIceMachine.isItemFuel(itemstack1))
                {
