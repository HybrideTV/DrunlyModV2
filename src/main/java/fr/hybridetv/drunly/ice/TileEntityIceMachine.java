...
public class TileEntityIceMachine extends TileEntityLockable implements ITickable, ISidedInventory
{
	...
	{
		return this.hasCustomName() ? this.furnaceCustomName : "container.ice_machine";
	}
	...
	{
		fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityIceMachine.class, new String[] {"Items"}));
	}
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                IceMachine.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = IceMachineRecipes.instance().getCookingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = IceMachineRecipes.instance().getCookingResult(itemstack);
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) 
    {
    	...
    	{
    		ItemStack itemStack = this.furnaceItemStacks.get(1);
    		return isItemFuel(stack) || SlotIceMachineFuel.isBucket(stack) && itemStack.getItem() != Items.BUCKET;
    	}
    }
    ...
    {
    	return new ContainerIceMachine(playerInventory, this);
    }
