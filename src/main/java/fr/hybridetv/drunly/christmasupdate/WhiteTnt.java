...
public class WhiteTnt extends Block {

	public static final PropertyBool EXPLODE = PropertyBool.create("explode");

    public WhiteTnt(String name)
    {
        super(Material.TNT);
    ...
    public void onBlockDestroyedByExplosion(World worldIn, BlockPos pos, Explosion explosionIn)
    {
        if (!worldIn.isRemote)
        {
            ...
            entitytntprimed.setFuse((short)(worldIn.rand.nextInt(entitytntprimed.getFuse() / 16) + entitytntprimed.getFuse() / 8));
    ...
    public void explode(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase igniter)
    {
        if (!worldIn.isRemote)
        {
            ...
            {
                EntityTNTPrimed entitytntprimed = new EntityTNTPrimed(worldIn, (double)((float)pos.getX() + 1.0F), (double)pos.getY(), (double)((float)pos.getZ() + 0.5F), igniter);
                worldIn.spawnEntity(entitytntprimed);
                worldIn.spawnEntity(entitytntprimed);
