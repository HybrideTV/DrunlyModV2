...
public class PotatoSeedPlanter extends ItemHoe {
private final float speed;
	
	public PotatoSeedPlanter (ToolMaterial material) {
		super(material);
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float X, float Y, float Z)
    {
        ...
        else
        {
            ...
            if (facing != EnumFacing.DOWN && worldIn.isAirBlock(pos.up()))
            {
                ...
                {
                	this.setBlock(itemstack, player, worldIn, pos.add(X - 1, Y + 1, Z - 1), Blocks.POTATOES.getDefaultState());
                	this.setBlock(itemstack, player, worldIn, pos.add(X, Y + 1, Z), Blocks.POTATOES.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X - 1, Y + 1 , Z - 1), Blocks.POTATOES.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X + 1, Y + 1, Z + 1), Blocks.POTATOES.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X, Y + 1, Z + 1), Blocks.POTATOES.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X + 1, Y + 1, Z), Blocks.POTATOES.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X - 1, Y + 1, Z), Blocks.POTATOES.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X, Y + 1, Z - 1), Blocks.POTATOES.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X + 1, Y + 1, Z - 1), Blocks.POTATOES.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X - 1, Y + 1, Z + 1), Blocks.POTATOES.getDefaultState());
                ...
                if (block == Blocks.FARMLAND)
                {
                    ...
                    {
                        case DIRT:
                            this.setBlock(itemstack, player, worldIn, pos, Blocks.POTATOES.getDefaultState());
                        	this.setBlock(itemstack, player, worldIn, pos.add(X, Y - 1, Z), Blocks.POTATOES.getDefaultState());
                            this.setBlock(itemstack, player, worldIn, pos.add(X - 1, Y - 1, Z - 1), Blocks.POTATOES.getDefaultState());
                            this.setBlock(itemstack, player, worldIn, pos.add(X + 1, Y - 1, Z + 1), Blocks.POTATOES.getDefaultState());
                            this.setBlock(itemstack, player, worldIn, pos.add(X, Y - 1, Z + 1), Blocks.POTATOES.getDefaultState());
