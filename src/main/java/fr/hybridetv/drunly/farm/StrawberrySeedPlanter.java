...
public class StrawberrySeedPlanter extends ItemHoe {
private final float speed;
	
	public StrawberrySeedPlanter (ToolMaterial material) {
		super(material);
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float X, float Y, float Z)
    {
        ...
        else
        {
            ...
            if (facing != EnumFacing.DOWN && worldIn.isAirBlock(pos.up()))
            {
                ...
                {
                	this.setBlock(itemstack, player, worldIn, pos.add(X - 1, Y + 1, Z - 1), BlocksMod.fraisecrop.getDefaultState());
                	this.setBlock(itemstack, player, worldIn, pos.add(X, Y + 1, Z), BlocksMod.fraisecrop.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X - 1, Y + 1 , Z - 1), BlocksMod.fraisecrop.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X + 1, Y + 1, Z + 1), BlocksMod.fraisecrop.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X, Y + 1, Z + 1), BlocksMod.fraisecrop.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X + 1, Y + 1, Z), BlocksMod.fraisecrop.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X - 1, Y + 1, Z), BlocksMod.fraisecrop.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X, Y + 1, Z - 1), BlocksMod.fraisecrop.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X + 1, Y + 1, Z - 1), BlocksMod.fraisecrop.getDefaultState());
                    this.setBlock(itemstack, player, worldIn, pos.add(X - 1, Y + 1, Z + 1), BlocksMod.fraisecrop.getDefaultState());
                ...
                if (block == Blocks.FARMLAND)
                {
                    ...
                    {
                        case DIRT:
                            this.setBlock(itemstack, player, worldIn, pos, BlocksMod.fraisecrop.getDefaultState());
                        	this.setBlock(itemstack, player, worldIn, pos.add(X, Y - 1, Z), BlocksMod.fraisecrop.getDefaultState());
                            this.setBlock(itemstack, player, worldIn, pos.add(X - 1, Y - 1, Z - 1), BlocksMod.fraisecrop.getDefaultState());
                            this.setBlock(itemstack, player, worldIn, pos.add(X + 1, Y - 1, Z + 1), BlocksMod.fraisecrop.getDefaultState());
                            this.setBlock(itemstack, player, worldIn, pos.add(X, Y - 1, Z + 1), BlocksMod.fraisecrop.getDefaultState());
