...
public class SilverFurnace extends BlockContainer
{
	...
	{
		playerIn.openGui(Drunly.instance, ModConfiguration.GUI_SILVER_FURNACE, worldIn, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
	...
	public static void setState(boolean active, World worldIn, BlockPos pos)
    {
        ...
        if (active)
        {
            worldIn.setBlockState(pos, BlocksMod.SILVER_FURNACE_ON.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BlocksMod.SILVER_FURNACE_ON.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
        else
        {
            worldIn.setBlockState(pos, BlocksMod.SILVER_FURNACE_OFF.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
            worldIn.setBlockState(pos, BlocksMod.SILVER_FURNACE_OFF.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
        }
	...
	{
		return new ItemStack(BlocksMod.SILVER_FURNACE_OFF);
	}
