package fr.hybridetv.drunly.hammers;
...
public class EmeraldHammer extends ItemPickaxe{
	
	public EmeraldHammer(ToolMaterial toolemeraldhammer) {
		
		super(toolemeraldhammer);
